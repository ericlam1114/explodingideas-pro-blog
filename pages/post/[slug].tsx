...
const Post = ({ post }: PostType) => {
  ...
  return (
    ...
    projectId={process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || "vhhvhe9q"}
    content={post.body}
    serializers={{
      ...
      link: ({ href, children }: any) => (
        <a href={href} className="my-link-class">
          {children}
        </a>
      ),
      normal: ({ children }: any) => (
  ...
  />
        ...
        <div>
          ...
          {/* Comments */}
          <div className="w-full flex flex-col p-10 my-10 mx-auto rounded-sm space-y-2">

...
const Footer = () => {
  return (
    <div className="w-full py-10 bg-yellow-300 text-black px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-4 justify-center items-center md:justify-between">
        <div className="flex items-center gap-3">
         ...
         <Link href="www.explodingideas.co"> <p className="flex items-center text-sm font-titleFont gap-1">
            <AiOutlineCopyrightCircle className="mt-[1px]" />
            Explodingideas.co || all rights reserved
          </p></Link>
        </div>
        ...
        <div className="flex gap-6">
         ...
         <Link href="www.twitter.com/ericlamideas" target="_blank"> <BsTwitter className="w-6 h-6 text-black hover:scale-95 duration-300 cursor-pointer" /></Link>
        </div>
      </div>
    </div>
  );
